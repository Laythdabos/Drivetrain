...
public class DriveSubsystem extends SubsystemBase {
  ...
  private static final WPI_TalonFX frontLeftMotor = RobotMap.frontLeftDriveMotor;
  private static final WPI_TalonFX frontRightMotor = RobotMap.frontRightDriveMotor;
  private static final WPI_TalonFX backLeftMotor = RobotMap.backLeftDriveMotor;
  private static final WPI_TalonFX backRightMotor = RobotMap.backRightDriveMotor;
  ...
  public double getBackLeftEncoderVelocityMetersPerSecond() {
    ...
    double backLeftVelocityMPS = (backLeftMotor.getSelectedSensorVelocity() * 10); 
  ...
  public double getBackRightEncoderVelocityMetersPerSecond() {
    ...
    double backRightVelocityMPS = (backRightMotor.getSelectedSensorVelocity() * 10); 
